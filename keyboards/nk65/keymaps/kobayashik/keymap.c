...
[1] = LAYOUT_65_ansi( /* FN */
    ...
    KC_TRNS, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  BR_DEC,  BR_INC,  ES_DEC,  ES_INC,  KC_TRNS,          KC_VOLU, KC_TRNS,\
    _______, _______, _______,                KC_TRNS,                               KC_TRNS, KC_TRNS, KC_TRNS, KC_MPRV, KC_VOLD, KC_MNXT),
};
